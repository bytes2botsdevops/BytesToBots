...
<body>
    <div class="page-wrapper">
                ...
                <div class="container clearfix">
                    ...
                    <div class="header-inner d-lg-flex align-items-center">
                        ...
                        <div class="logo-outer d-flex align-items-center">
                            <div class="logo"><a href="index.jsp"><img src="assets/images/logo1.png" alt="" title=""></a></div>
                        </div>
        ...
        <!--==================================================================== 
            Start Job Listing Section
        =====================================================================-->


		<div class="container"
			style="border: solid; border-color: black; border-size: 10px;">
			<div class="search-section"
				style="min-height: 380px; width: 100%; background-position: center; background-repeat: no-repeat; background-size: cover; position: relative; background-image: url("assets/images/joblisting-bg.jpg");">
