                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <p>Register with us for better opportunities.</p>
                            ...
                            if ( null!=actionMessage && !"".equalsIgnoreCase(actionMessage) && "success".equalsIgnoreCase(actionMessage))
                            {
                            out.println("<div style=\"color: green; font-style: bold;\">");
                            out.println("Succefully Registered");
                        	out.println("</div>");
                            }
                            else if (null!=actionMessage && !"".equalsIgnoreCase(actionMessage) && "error".equalsIgnoreCase(actionMessage))
                            {
                            out.println("<div style=\"color: red; font-style: bold;\">");
                            out.println("Error while Registering, Please try later");                            
                        	out.println("</div>");
                            }
                            %>
                            </div>
                        <form id="register-form" class="call-back-form" name="call-back-form" action="controller?action=register" method="post">
                            <div class="row clearfix">

                                <div class="col-md-6">        
                                    <div class="form-group">
                                        <input type="text" name="firstname" class="form-control"  placeholder="First Name" required="" data-toggle="tooltip" data-placement="right" title="First Name">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6">        
                                    <div class="form-group">
                                        <input type="text" name="lastname" class="form-control"  placeholder="Last Name" required="" data-toggle="tooltip" data-placement="right" title="Last Name">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="email" name="email" class="form-control"  placeholder="Email" required="" data-toggle="tooltip" data-placement="right" title="Email">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-control"  placeholder="Password" required="" data-toggle="tooltip" data-placement="right" title="Password">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="phone" class="form-control"  placeholder="Phone Number" data-toggle="tooltip" data-placement="right" title="Mobile">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="date" name="dob" class="form-control"  placeholder="DD-MM-YYYY" data-toggle="tooltip" data-placement="right" title="Date of Birth">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center">
                                <button class="theme-btn" type="submit">Register <i class="fas fa-arrow-right"></i></button>
                            </div>
                            </div>
