...
<head>
    ...
    <title>404_Error || Conset - Business Consulting HTML5 Template</title>
        ...
        <section class="error-section pt-200 rpt-100 pb-185 rpb-85">
            <div class="container">
                <div class="error-image text-center">
                    <img src="assets/images/error-page/404-error.png" alt="Error Image">
                </div>
                <div class="error-content">
                    ...
                    <div class="content-right wow fadeInUp" data-wow-duration="1.5s">
                        <a href="index.jsp" class="theme-btn"><i class="fas fa-arrow-left"></i> Back To Home</a>
                    </div>
                </div>
            </div>
        </section>
