                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="widget menu-widget">
                            ...
                            <ul>
                                <li><a href="service-details.jsp">Global Solutions</a></li>
                                <li><a href="service-details.jsp">IT Consulting</a></li>  
                                <li><a href="service-details.jsp">Recruting Services</a></li>
