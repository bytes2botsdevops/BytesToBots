...
<script>
	...
	function getInfo() {
		if (request.readyState == 4) {
			...
			document.getElementById('insertStatus').innerHTML = val;
		}
	}
</script>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<form id="call-back-form" class="call-back-form"
						name="call-back-form" action="" method="post">
						...
						<div class="form-group call-submit text-center">
							<button class="theme-btn" type="submit" onClick="sendInfo()">
