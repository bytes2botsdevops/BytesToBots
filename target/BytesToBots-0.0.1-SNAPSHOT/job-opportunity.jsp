                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current-menu-item"><a href="job-opportunity.jsp">Hot Jobs</a></li>
        ...
        <section class="page-banner overlay">
            <div class="container">
                <div class="banner-inner">
                    <h2 style = "color : #ffffff;"class="wow fadeInUp" data-wow-duration="1.5s">Current Job Openings</h2>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="case-sidebar">
                            <div class="sidebar-widget information-widget bg-snow">
                                ...
                                <ul>
                                    <li><span>Education </span> B.Tech</li>
                                    <li><span>Experience </span> 2-4 years</li>
                                    <li><span>Skills </span> Linux, Python</li>
                                    ...
                                    <li><span>Notice </span> 01 month.</li>
                                </ul>
                            </div>
                            <div class="sidebar-widget contact-widget text-center bg-black">
                                <p style="font-size: 25px">APPLY TODAY</p>
                                <h3>Hiring Freshers Now</h3>
                    ...
                    <div class="col-lg-4">
                        <div class="case-sidebar">
                            ...
                            <div class="sidebar-widget contact-widget text-center bg-black">
                                <p style="font-size: 25px">WE ARE READY</p>
                    ...
                    <div class="col-lg-8">
                        <div class="case-details-content">
                            ...
                            <div class="prev-next-area">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a class="prev-next-btn prev-btn wow fadeInUp" data-wow-duration="2s" href="case-details.jsp"><span>Previous.</span></a>
                                    </div>
                                    <div class="col-sm-6">
                                        <a class="prev-next-btn next-btn wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s" href="case-details.jsp"><span>Next.</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="case-item wow fadeInUp" data-wow-duration="2s">
                            <div class="case-image">
                                ...
                                <a href="case-details.jsp"><i class="fas fa-angle-double-right"></i></a>
                            </div>
                            <div class="case-content">
                                <span>HOME / LAND</span>
                                <h4><a href="case-details.jsp">Mortgage Advisor</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="case-item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
                            ...
                            <div class="case-content">
                                ...
                                <h4><a href="case-details.jsp">Online Consulting</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="case-item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
                            ...
                            <div class="case-content">
                                ...
                                <h4><a href="case-details.jsp">Planning & Management</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="cta-text wow fadeInUp rmb-25" data-wow-duration="2s">
                            <h3>Are you on the lookout for a new position???</h3>
                        </div>
                    </div>
                    <div class="col-lg-4">
