            ...
            <div class="container">
                <div class="row">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="right-content">
                                            B1, Prashanthi Kuteera, Kadugodi, Whitefield, Bangalore 560067
                                        </div>
                                    </li>
                                    <li>
                                        <div class="left-icon">
                                        ...
                                        <div class="right-content">
                                            <a href="callto:+91 8884966873">+91 8884966873</a><br/>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="left-icon">
                                        ...
                                        <div class="right-content">
                                            <a href="mailto:hr@bytes2bots.com">hr@bytes2bots.com</a><br>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <p>If you have any questions or queries, our expert will always be appy to help. Feel free to contact us by mobile or email and we will be sure to get back to you as soon as possible.</p>
                        <form id="call-back-form" class="call-back-form" name="call-back-form" action="UploadResume" method="post" enctype="multipart/form-data">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">        
                                    <div class="form-group">
                                        <input type="file" name="resume" class="form-control" value="" placeholder="Upload Resume" required="">
                                    </div>
                                </div>
